[assembly: WebActivator.PreApplicationStartMethod(typeof(Nokatak.App_Start.NinjectMVC3), "Start")]
[assembly: WebActivator.ApplicationShutdownMethodAttribute(typeof(Nokatak.App_Start.NinjectMVC3), "Stop")]

namespace Nokatak.App_Start
{
    ...
    public static class NinjectMVC3
    {
        ...
        private static void RegisterFacebookServices(IKernel kernel)
        {
            kernel.Bind<IMyFacebookAppSettings>()
                ...
                {
                    AppId = "432537273435666",
                    AppSecret = "b8bbb8dfc0cbd0b21d5590a4c7c48834",
                    CanvasPageName = "Nokatak", /* only the canvas page name and not the full url */
